...
* **The Architecture:** Fuses a retro command-line console interface with intricate, hand-drawn digital illustration overlays. Users act as Decryptors to audit cognitive sub-processes and fix systemic memory anomalies.
* **The Core Liturgy:** Supported by a 100-page *Consciousness Operating System Manual* serving as the system's kernel documentation (a hardcopy copy is archived permanently in the San Diego Central Library).
